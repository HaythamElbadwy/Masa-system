...
import styles from './ResellerDetails.module.css';
            ...
            <tbody>
              {isAllResellerCustomer.map((subscribes, index) => (
                <tr key={index}>
                  ...
                  {/* <td scope="col" className="px-6 py-4 text-[#3E3D3D]"></td> */}
                  ...
                  <td scope="col" className="px-6 py-3 text-[#3E3D3D]">
                    <i className="fa-solid fa-circle-info cursor-pointer" onClick={() => notePopUp(subscribes.note)}></i></td>
                  {/* <td scope="col" className="px-6 py-3 text-[#3E3D3D]">
