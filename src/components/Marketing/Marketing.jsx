...
export default function Marketing() {
  ...
  const getCustomer = async (page, isAppFilter, isProviderFilter, from, to, isStatueFilter) => {
    ...
    try {
      const response = await fetch(`https://masa-system.vercel.app/api/v1/customer/get?page=${page}&app=${isAppFilter}&statue=${isStatueFilter}&provider=${isProviderFilter}&from=${from}&to=${to}&employee=Admin`, {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
          'authorization': `sysOM0${localStorage.getItem('authToken')}`
