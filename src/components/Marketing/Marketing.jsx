...
export default function Marketing() {
  ...
  useEffect(() => {
    if (accessToken != 'a3f1de57756b9cb249f5e2c7e5af957b') {
  ...
  const getCustomer = async (page, isAppFilter, isProviderFilter, isDateFilter, isStatueFilter) => {
    ...
    try {
      const response = await fetch(`https://masa-system.vercel.app/api/v1/customer/get?page=${page}&app=${isAppFilter}&statue=${isStatueFilter}&provider=${isProviderFilter}&date=${isDateFilter}&employee=Admin`, {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
          'authorization': `sysOM0${localStorage.getItem('authToken')}`
  ...
  //////////////////////START EDITE MARKETING CUSTOMERS///////////////////////////////////
  ...
  const handleDownload = async () => {
    try {
      ...
      link.href = url;
      link.setAttribute('download', 'MarketingCustomers.xlsx');
  ...
  return (
    <>
      <section className='mt-24 pl-10 pr-10'>
        ...
        <div className={`${styles.marketing_table} `}>
          <div className='flex'>
          ...
          <table className='table-auto w-full mt-4'>
            <thead className='bg-white border-b dark:bg-gray-800 dark:border-gray-700 '>
              <tr className={`${styles.marketing_header}`}>
                ...
                <th scope="col" className="py-3">
                  <input
                    type="date"
                    className="border bg-[#d1d1d1] border-gray-300 rounded py-1 text-sm focus:outline-none"
                    onChange={(e) => handleFilterDate(e.target.value)} /></th>
                <th scope="col" className="py-3">
                  <select
                    className="border bg-[#d1d1d1] border-gray-300 rounded py-1 text-sm focus:outline-none"
                      ...
                      <div className='flex items-center justify-center col-span-2'>
                        ...
                        <div className='w-1/2 mr-[-17px]'>
                          ...
                          <div className='flex'>
                            ...
                            <select id="countries" className="mx-5 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-16 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                              <option>$</option>
                              <option>Euro</option>
